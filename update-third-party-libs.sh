...
(cd client/vendor/; wget -N http://twitter.github.io/typeahead.js/releases/latest/typeahead.bundle.js)
...
(cd client/vendor/; wget -N https://github.com/arshaw/fullcalendar/raw/master/dist/fullcalendar.js)
(cd css/components/; wget -N https://github.com/arshaw/fullcalendar/raw/master/dist/fullcalendar.import.less)

(cd client/vendor/; wget -N https://raw.githubusercontent.com/jonthornton/jquery-timepicker/master/jquery.timepicker.js)
...
(cd client/vendor/; wget -N https://raw.githubusercontent.com/jmosbech/StickyTableHeaders/master/js/jquery.stickytableheaders.js)
