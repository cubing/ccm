...
Round.MIN_ROUND_DURATION = moment.duration(30, 'minutes');
Round.DEFAULT_ROUND_DURATION = moment.duration(60, 'minutes');
...
Rounds.attachSchema({
  ...
  durationMinutes: {
    type: Number,
    min: Round.MIN_ROUND_DURATION.asMinutes(),
    defaultValue: Round.DEFAULT_ROUND_DURATION.asMinutes(),
  },
