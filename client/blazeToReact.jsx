// TODO - this should really get pulled out into a Meteor (or npm?) package.
...
BlazeToReact = React.createClass({
  ...
  render() {
    return React.createElement(this.props.wrapperTag, { className: this.props.wrapperClass, ref: this.props.blazeTemplate });
  }
});
